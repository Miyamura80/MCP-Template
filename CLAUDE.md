...
- **`docs/`** — Next.js + Fumadocs site; English source in `docs/content/en/`. Translations under `docs/content/{es,ja,zh}/` are auto-generated by the Jules sync workflow — do not edit by hand. See [`docs/translation-guide.md`](docs/translation-guide.md).
