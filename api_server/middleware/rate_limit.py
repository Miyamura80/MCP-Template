...
class RateLimitMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(
        ...
        # First check all windows without consuming quota, then hit() all
        # if none are exceeded. This prevents leaking quota from earlier
        # windows when a later window rejects the request.
        hit_window = None
        hit_item = None
