...
```bash
npx @modelcontextprotocol/inspector uv --directory /path/to/MCP-Template run mymcp-mcp
```
...
- Try running `uv --directory /path/to/MCP-Template run mymcp-mcp` manually to check for errors
